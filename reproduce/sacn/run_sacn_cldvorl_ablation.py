...
def vanilla(args):
    ...
    logger = CompositeLogger(log_path=f"./results/sacn/vanilla", name=exp_name, loggers_config={
    ...
    for i_epoch in trange(1, args.max_epoch + 1):
        ...
        if i_epoch % args.save_interval == 0:
            logger.log_object(name=f"policy_{i_epoch}.pt", object=policy.state_dict(),
                              path=f"./models/sacn/{args.task}/{args.d4rl_source_env}_{args.d4rl_target_env}/seed{args.seed}/policy")
...
def without_CL(args):
    ...
    logger = CompositeLogger(log_path=f"./results/sacn/withoutCL", name=exp_name, loggers_config={
        "FileLogger": {"activate": not args.debug},
        "TensorboardLogger": {"activate": not args.debug},
        "WandbLogger": {"activate": not args.debug, "config": args, "settings": wandb.Settings(_disable_stats=True), **args.wandb}
    })
    ...
    delta_model_path = f"./models/sacn/{args.task}/{args.d4rl_source_env}_{args.d4rl_target_env}"
    ...
    results_dir = f"./models/sacn/{args.task}/{args.d4rl_source_env}_{args.d4rl_target_env}/dve"
...
def traj_valuation(args):
    ...
    if args.run_dcla_ratio:
        logger = CompositeLogger(
            log_path=f"./ablation_results/sacn/{args.d4rl_source_env.split('-')[0]}/{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}/dcla_ratio/{args.dcla_ratio}",
            name=f"sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_dcla_ratio_{args.dcla_ratio}_seed_{args.seed}",
            loggers_config={
                "FileLogger": {"activate": not args.debug},
                "TensorboardLogger": {"activate": not args.debug},
        ...
        logger = CompositeLogger(
            log_path=f"./ablation_results/sacn/{args.d4rl_source_env.split('-')[0]}/{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}/modify_ratio/{args.modify_ratio}/",
            name=f"sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_modify_ratio_{args.modify_ratio}_seed_{args.seed}",
            loggers_config={
                "FileLogger": {"activate": not args.debug},
                "TensorboardLogger": {"activate": not args.debug},
                "WandbLogger": {"activate": not args.debug, "config": args,
        ...
        logger = CompositeLogger(
            log_path=f"./ablation_results/sacn/{args.d4rl_source_env.split('-')[0]}/{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}/std_scale/{args.std_scale}/",
            name=f"sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_std_scale_{args.std_scale}_seed_{args.seed}",
            loggers_config={
                "FileLogger": {"activate": not args.debug},
                "TensorboardLogger": {"activate": not args.debug},
                "WandbLogger": {"activate": not args.debug, "config": args,
    ...
    if args.run_dcla_ratio:
        np.save(
            logger.log_path + f"/avg_rewards_sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_dcla_ratio_{args.dcla_ratio}_seed_{args.seed}.npy",
            avg_rewards)
    elif args.run_modify_ratio:
        np.save(
            logger.log_path + f"/avg_rewards_sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_modify_ratio_{args.modify_ratio}_seed_{args.seed}.npy",
            avg_rewards)
    elif args.run_std_scale:
        np.save(
            logger.log_path + f"/avg_rewards_sacn_{args.d4rl_source_env.split('-')[0]}_{args.d4rl_source_env.split('-')[1]}_{args.d4rl_target_env.split('-')[1]}_std_scale_{args.std_scale}_seed_{args.seed}.npy",
            avg_rewards)
...
def main(pass_in=None):
    args = parse_args('./reproduce/sacn/config/offline/cldv/base.py')
